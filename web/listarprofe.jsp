<%-- 
    Document   : listarprofe
    Created on : 23/10/2019, 06:44:04 PM
    Author     : 503
--%>
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="table-header">
											Resultados de cursos registrados
										</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<tr>
														...
														<td class="hidden-480">Matricula</td>
														<td>Sail</td>

														<td>2017-2012-1331</td>
                            <td><span class="label label-sm label-success">2017</span></td>
                            <td>
															<span class="label label-sm label-success">Curso</span>
														</td>
